    ...
    <div className="page-wrap">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          {project.creates_agent ? <span className="badge" title="Agent auto-creation enabled">🤖 agent</span> : null}
      ...
      {project.creates_agent && <p className="text-xs text-soft mt-1">🤖 Agent auto-creation enabled for this project</p>}
